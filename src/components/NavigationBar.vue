...
<template>
  <div class="nav-bar">
    ...
    <div class="list" v-if="store.currentNav=='exercise'">
      ...
      :key="paper.id"
      @click="store.currentPaperId=paper.id">
        <div v-if="paper.type=='exercise'" class="item" :class="{selected:store.currentPaperId==paper.id}">
          {{paper.title}}
        </div>
      </div>
    </div>
    ...
    <div class="list" v-if="store.currentNav=='exam'">
      ...
      :class="{selected:store.currentPaperId==paper.id}">
        <div v-if="paper.type=='exam'" class="item" :class="{selected:store.currentPaperId==paper.id}">
          {{paper.title}}
        </div>
      </div>
    </div>
